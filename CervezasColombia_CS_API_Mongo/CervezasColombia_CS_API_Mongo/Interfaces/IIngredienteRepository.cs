...
namespace CervezasColombia_CS_API_Mongo.Interfaces
{
    public interface IIngredienteRepository
    {
        ...
        public Task<int> GetTotalAssociatedBeersAsync(string ingrediente_id);
        public Task<IEnumerable<IngredienteCerveza>> GetAssociatedBeersAsync(string ingrediente_id);
