...
namespace CervezasColombia_CS_API_Mongo.Services
{
    public class IngredienteService
    {
        ...
        public async Task<IEnumerable<Cerveza>> GetAssociatedBeersAsync(string ingrediente_id)
        {
            //Validamos que el ingrediente exista con ese Id
            var unIngrediente = await _ingredienteRepository
                .GetByIdAsync(ingrediente_id);
        ...
        public async Task<Ingrediente> UpdateAsync(string ingrediente_id, Ingrediente unIngrediente)
        {
        ...
        public async Task DeleteAsync(string ingrediente_id)
        {
